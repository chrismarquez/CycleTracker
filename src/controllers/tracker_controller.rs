...
#[get("/<tracker_id>")]
async fn get_tracker(tracker_service: &Managed<TrackerService>, tracker_id: i32) -> Json<Tracker> {
...
#[get("/")]
async fn get_all_tracker(tracker_service: &Managed<TrackerService>) -> Json<Vec<i32>> {
...
async fn create_tracker(
    tracker_service: &Managed<TrackerService>,
    tracker_id: i32,
